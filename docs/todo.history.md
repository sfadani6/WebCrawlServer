...
## 2026-07-27 20:05:34 - 플러그인 연결 도우미 표시 보강

- 항목명: 플러그인 연결 안내 화면 보강
- 상세 이력: `docs/askLogs/ask-20260727200534.md`
- 결과 요약: `/plugins` 화면에 항상 보이는 연결 도우미를 추가하여 WebSocket URL 복사, 승인 상태 카운트, 플러그인 연결 절차를 한 화면에서 확인할 수 있게 하였다.
