      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            border: 'none',
            borderBottom: activeTab === 'dashboard' ? '2px solid var(--gcp-accent)' : '2px solid transparent',
            backgroundColor: 'transparent',
            color: activeTab === 'dashboard' ? 'var(--gcp-accent)' : 'var(--gcp-text-secondary)',
            cursor: 'pointer'
          }}
        >
          ⚡ 실시간 WebSocket 대시보드
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            border: 'none',
            borderBottom: activeTab === 'list' ? '2px solid var(--gcp-accent)' : '2px solid transparent',
            backgroundColor: 'transparent',
            color: activeTab === 'list' ? 'var(--gcp-accent)' : 'var(--gcp-text-secondary)',
            cursor: 'pointer'
          }}
        >
          📡 클라이언트 연결 목록
